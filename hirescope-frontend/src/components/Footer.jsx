  ...
  const socialLinks = [
    {
      ...
      href: "mailto:parth.sharma@example.com" // Replace with your email
    },
    {
      name: "LinkedIn",
      icon: (
      ...
      href: "https://linkedin.com/in/parthsharma272" // Replace with your LinkedIn
    },
    {
      name: "GitHub",
      icon: (
    ...
    },
    {
      ...
      href: "https://twitter.com/parthsharma272" // Replace with your Twitter/X
    },
    {
      name: "WhatsApp",
      icon: (
      ...
      href: "https://wa.me/1234567890" // Replace with your WhatsApp number (international format)
    },
    {
      name: "Reddit",
      icon: (
      ...
      href: "https://reddit.com/user/parthsharma272" // Replace with your Reddit
    }
  ];

  const quickLinks = [
    { name: "Resume Analysis", href: "#upload" },
