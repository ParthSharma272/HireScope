        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="flex items-center gap-2">
            ...
            <a
              ...
              className="group flex items-center gap-2 px-4 py-2 bg-white border-2 border-purple-500 hover:border-purple-600 text-gray-900 rounded-full font-medium transition-all duration-200 hover:shadow-md transform hover:scale-105 ml-2"
            >
